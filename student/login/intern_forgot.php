...
<head>
    ...
    <title>Forgot Password - Internship | T&P SVNIT</title>
    ...
    <div class="forgot-card">
        ...
        <div class="card-body">
            <form method="post" action="intern_forgot.php">
                ...
                <div class="input-group">
                    <button type="submit" class="btn" name="intern_forgot">Reset Password</button>
                </div>
                <?php endif ?>
                ...
                <div class="links-section">
                    <?php if (count($positives) > 0) : ?>
                        <p>
                            Check your email and <a href="student_login_int.php">login with new password</a>
                        </p>
                    <?php else : ?>
                        <p>
                            Remember your password? <a href="student_login_int.php">Back to Login</a>
                        </p>
                    <?php endif ?>
                </div>
            </form>

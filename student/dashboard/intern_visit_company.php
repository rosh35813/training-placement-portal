...
<head>
    ...
    <title>Internship Companies | T&P SVNIT</title>
...
<div class="container">
    <div class="page-header">
        <h1>🚀 Companies - Internship</h1>
        <p>View all approved companies visiting for internship opportunities</p>
    </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><span class="badge badge-stipend"><?php echo $count['MAX_STIPEND']; ?></span></td>
                            <td><?php echo $count['JOB_PROFILE']; ?></td>
                            <td><?php echo $count['PLACE_OF_POSTING']; ?></td>
                            <td><a href="<?php echo $count['WEBSITE']; ?>" target="_blank"><?php echo $count['WEBSITE']; ?></a></td>
                        </tr>
                    <?php
                        }
                    } else {
                        ...
                        <tr>
                            <td colspan="9">
                                <div class="empty-state">
                                    ...
                                    <p>There are currently no approved internship companies scheduled to visit.</p>
                                </div>
                            </td>
                        </tr>
                    <?php

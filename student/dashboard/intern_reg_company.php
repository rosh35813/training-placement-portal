...
<div class="container">
    <div class="applications-card">
        <div class="card-header">
            ...
            <p>Companies you have applied to for internship</p>
        </div>
        ...
        <div class="card-body">
            ...
            if($status == 'NS')
            {
                $stmt = $db->prepare("SELECT DISTINCT COMPANY_NAME from registered_interns where STUDENT_ID=?");
                $stmt->bind_param('s', $stu_id);
                $stmt->execute();
                $result = $stmt->get_result();
                $stmt->close();
            ...
            ?>
                    <div class="empty-state">
                        ...
                        <p>You haven't applied to any companies yet. Start applying to internship opportunities!</p>
                        <a href="apply_intern.php" class="empty-state-button">Apply Now</a>
                    </div>
            <?php
                }
            } else {
            ?>
                <div class="placed-state">
                    ...
                    <p>You have secured an internship. Application tracking is no longer available.</p>
                </div>
            <?php
            }
            ?>

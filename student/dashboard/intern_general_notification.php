...
<div class="container">
    <div class="notifications-card">
        <div class="card-header">
            ...
            <p>Stay updated with important announcements for internships</p>
        </div>
        ...
        <div class="card-body">
            ...
            if (!$db) {
                ...
                // Table `intern_notification` does not have an `id` column in the DB schema.
                ...
                $stmt = $db->prepare("SELECT * FROM intern_notification ORDER BY noti DESC");
                $stmt->execute();

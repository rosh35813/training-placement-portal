...
if (isset($_POST['add_intern_gen_noti'])) 
{
  ...
  {
    $stmt = $db->prepare("INSERT INTO intern_notification (noti) VALUES(?)");
    $stmt->bind_param('s', $noti);
    $stmt->execute();
    $stmt->close();
    array_push($positives, "Notification published successfully! All intern students will see this message.");
    $noti = ""; // Clear after success
  }
}

// Get recent notifications count
$stmt = $db->prepare("SELECT COUNT(*) as count FROM intern_notification");
$stmt->execute();
...
<head>
    ...
    <title>Internship Notification - T&P SVNIT</title>
...
<div class="container">
    <div class="notification-card">
        <div class="card-header">
            <h2>Internship Notification</h2>
            <p>Broadcast announcements to all internship students</p>
        </div>
        ...
        <div class="card-body">
            ...
            <form method="post" action="add_intern_gen_noti.php" id="notificationForm">
                ...
                <div class="info-box">
                    ...
                    Keep messages clear and professional. Include important dates, deadlines, or action items. Students will receive this as a general announcement.
                </div>
                ...
                <div class="input-group">
                    ...
                    <textarea 
                        name="noti" 
                        id="notificationText"
                        placeholder="Example: Important Update: All internship students are requested to attend the Pre-Placement Talk on November 15, 2025 at 3:00 PM in Seminar Hall. Attendance is mandatory."
                        maxlength="500"
                        required
                ...
                <div class="formatting-tips">
                    <h4>💡 Writing Tips</h4>
                    <div class="tips-grid">
                        <div class="tip-item">Start with action words</div>
                        <div class="tip-item">Include specific dates/times</div>
                        <div class="tip-item">Mention location if relevant</div>
                        <div class="tip-item">Specify if action is required</div>
                        <div class="tip-item">Keep it concise and clear</div>
                        <div class="tip-item">Proofread before publishing</div>
                    </div>
                </div>
                ...
                <div class="input-group">
                    <button type="submit" class="btn" name="add_intern_gen_noti" id="submitBtn">Publish Notification</button>
                </div>

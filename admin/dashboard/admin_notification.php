...
<head>
    ...
    <title>Admin Notifications - T&P SVNIT</title>
    ...
    <div class="main-container">
        ...
        <div class="section">
            <div class="section-title">
                ...
                <p>View current stats of the students</p>
            </div>

            <div class="cards-grid">
                <!-- First Card: Registered for Internship -->
                <div class="card">
                    <div class="card-icon">📋</div>
                    <h4>Registered for Internship</h4>
                    <p>View all students registered for internship opportunities</p>
                    <a href="admin_noti_reg_int.php" class="card-button">View Students</a>
                </div>

                <!-- Second Card: Selected for Internship -->
                <div class="card">
                    <div class="card-icon">✅</div>
                    <h4>Selected for Internship</h4>
                    <p>View students selected for internship positions</p>
                    <a href="admin_noti_select_int.php" class="card-button">View Selected</a>
                </div>

                <!-- Third Card: Registered for Placement -->
                <div class="card">
                    <div class="card-icon">💼</div>
                    <h4>Registered for Placement</h4>
                    <p>View all students registered for placement opportunities</p>
                    <a href="admin_noti_reg_place.php" class="card-button">View Students</a>
                </div>

                <!-- Fourth Card: Selected for Placement -->
                <div class="card">
                    <div class="card-icon">🎉</div>
                    <h4>Selected for Placement</h4>
                    <p>View students selected for placement positions</p>
                    <a href="admin_noti_select_place.php" class="card-button">View Selected</a>
                </div>
            </div>
        </div>
    </div>

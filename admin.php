...
<head>
    ...
    <title>Admin Portal - T&P SVNIT</title>
    ...
    <div class="main-container">
        ...
        <div class="section">
            <div class="section-title">
                <h3>Admin Access</h3>
                <p>Register or login to your administrator account</p>
            </div>
            ...
            <div class="cards-grid">
                <div class="card">
                    ...
                    <p>Create a new administrator account to manage the placement system</p>
                    <a href="admin_register.php" class="card-button">Register Now</a>
                </div>

                <div class="card">
                    <div class="card-icon">🔐</div>
                    <h4>Admin Login</h4>
                    <p>Access your administrator dashboard to manage placements</p>
                    <a href="admin_login.php" class="card-button">Login Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="section-title">
                ...
                <p>Placement policies and previous reports</p>
            </div>
